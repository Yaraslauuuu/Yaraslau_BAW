<?php
/* Smarty version 5.4.2, created on 2025-04-10 00:43:25
  from 'file:main.html' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_67f6f80d2dea11_28482048',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '15e22dc91910e82a3ba6f745e2c0bdf6c2bfc346' => 
    array (
      0 => 'main.html',
      1 => 1744238603,
      2 => 'file',
...
function content_67f6f80d2dea11_28482048 (\Smarty\Template $_smarty_tpl) {
...
<div id="page-wrapper">
    ...
    <!-- Убираем класс "alt", чтобы не было тёмной шапки -->
    <header id="header">
        <nav id="nav">
            <ul>
                <!-- При нажатии Home скрываем калькулятор и скроллим наверх -->
...
/signup" class="button">Sign Up</a></li>
    ...
    <!-- Блок регистрации (центрированный) -->
    ...
    <!-- Калькулятор (скрыт до нажатия на кнопку регистрации) -->
...
/app/calc.php" method="post">
    ...
    <!-- Подвал -->
    <footer id="footer">
        <!-- Можно добавить что угодно или оставить пустым -->
    </footer>
</div>
